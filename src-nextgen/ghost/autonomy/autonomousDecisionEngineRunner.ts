...
import {
  startAutonomousDecisionEngine,
  getAutonomousDecisionEngine,
} from "./autonomousDecisionEngine";
...
console.log(
  "[AutonomousDecisionEngineRunner] Starting Autonomous Decision Engine...",
);
...
process.on("unhandledRejection", async (reason, promise) => {
  console.error(
    "[AutonomousDecisionEngineRunner] Unhandled Rejection at",
    promise,
    ":",
    reason,
  );
...
async function main() {
  try {
    ...
    console.log(
      "[AutonomousDecisionEngineRunner] Autonomous Decision Engine started successfully",
    );
    ...
    console.error(
      "[AutonomousDecisionEngineRunner] Failed to start engine:",
      error,
    );
    process.exit(1);
  }
