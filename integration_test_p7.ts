...
import { ConfigurationValidationEngine } from './src-nextgen/ghost/validation/configurationValidationEngine';
import { MessageQueueSystem } from './src-nextgen/ghost/queue/messageQueueSystem';
import { HealthCheckAggregator } from './src-nextgen/ghost/monitoring/healthCheckAggregator';
import { AutonomousDecisionEngine } from './src-nextgen/ghost/autonomy/autonomousDecisionEngine';
import { GhostGptRelayCore } from './src-nextgen/ghost/relay/ghostGptRelayCore';
import { GhostAutopilotHealer } from './src-nextgen/ghost/healer/ghostAutopilotHealer';

// Import schema validation
import { 
  validateGptRelayInput, validateCliCommand, validateMessageQueue
