...
const _DEV_TUNNEL = "https://gpt-cursor-runner.thoughtmarks.app";
const _PROD_TUNNEL = "https://gpt-cursor-runner.thoughtmarks.app";
const _fallbackRunnerURL = "https://gpt-cursor-runner.thoughtmarks.app";
...
if (fs.existsSync(runnerEnvPath)) {
  const _env = fs.readFileSync(runnerEnvPath, "utf8");
