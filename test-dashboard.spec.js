...
test("Dashboard Health Validation", async ({ page }) => {
  ...
  // Check that the page title contains "***REMOVED*** RUNNER"
  await expect(page).toHaveTitle(/***REMOVED*** RUNNER/);

  // Check that the main heading is present
  await expect(page.locator("h1")).toContainText("***REMOVED*** RUNNER");
