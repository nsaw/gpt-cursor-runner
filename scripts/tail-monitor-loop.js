...
exec('nohup node scripts/hooks/summary-trace-autofill.js &> logs/summary-trace.log & disown', (err) => {
  if (err) {
...
exec('nohup node scripts/patch-executor-loop.js &> logs/patch-executor-loop.log & disown', (err) => {
  if (err) {
