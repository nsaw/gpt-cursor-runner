...
class LinterStats:
    ...
    language_stats: Optional[Dict[str, Dict[str, Any]]] = None
...
class SuperAutoLinter:
    ...
    def get_python_syntax_errors(self, file_path: str) -> List[Dict[str, Any]]:
    ...
    def get_all_python_errors(self, file_path: str) -> List[Dict[str, Any]]:
    ...
    def get_javascript_linter_errors(self, file_path: str) -> List[Dict[str, Any]]:
...
class FileChangeHandler(FileSystemEventHandler):
    ...
    def __init__(self, autolinter: SuperAutoLinter) -> None:
    ...
    def debounce_file_change(self, file_path: str) -> None:
