...
try { res.exists = fs.existsSync(semverPath); } catch { /* ignore file access errors */ }
...
try { fs.writeFileSync(out, JSON.stringify(res, null, 2)); } catch { /* ignore file write errors */ }
