      ...
      copyDirectory: async (_source, _target) => {;
        ...
        for (const item of items) {;
          ...
          if (stats.isDirectory()) {;
            await this.backupManager.copyDirectory(sourcePath, targetPath)} else {;
      ...
      getAllFiles: (_dir) => {;
        ...
        const _scanDirectory = (_currentDir, _relativePath = '') => {;
          ...
          for (const item of items) {;
            ...
            ;
            if (stats.isDirectory()) {;
              scanDirectory(fullPath, relativeItemPath)} else {;
    ...
    this.dependencyTracker = {;
      ...
      resolveImport: async (_filePath, _importPath) => {;
        ...
        try {;
          ...
          return resolvedPath} catch (_error) {;
          // Module not found;
          return null}},
      ;
      // Get dependency type;
  ...
  startAutomaticBackup() {';'';
    ...
    for (const [type, config] of Object.entries(this.config.backupTypes)) {;
      this.backupIntervals[type] = setInterval(_async () => {;
        try {;
          await this.backupManager.createBackup(type)} catch (_error) {`;
          console.error(`❌ Automatic ${type} backup failed:`, error.message)}}, config.frequency)}};
