...
function start_daemon() {
  log_message "🚀 Starting Command Queue Daemon..."
...
function stop_daemon() {
  log_message "🛑 Stopping Command Queue Daemon..."
...
function status() {
  if health_check; then
    echo "✅ Command Queue Daemon is running"
    ...
    echo "❌ Command Queue Daemon is not running"
  fi
}
