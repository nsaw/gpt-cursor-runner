...
console.log('[BRIDGE] extractor started');setInterval(()=>{const ids=fs.readFileSync(CHAT_FILE,'utf-8').split(/\n/).map(l=>l.trim()).filter(l=>l&&!l.startsWith('#'));ids.forEach(poll);},POLL_MS);
