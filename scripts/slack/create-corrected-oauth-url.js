...
const _oauthUrl = `https://slack.com/oauth/v2/authorize?client_id=${SLACK_CLIENT_ID}&scope=${VALID_SCOPES}&redirect_uri=${encodeURIComponent(REDIRECT_URI)}&state=corrected-install-${Date.now()}`;
';'';
