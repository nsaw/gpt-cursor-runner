...
;
const _oauthUrl = `https://slack.com/oauth/v2/authorize?client_id=${SLACK_CLIENT_ID}&scope=${REQUIRED_SCOPES}&redirect_uri=${encodeURIComponent(REDIRECT_URI)}&state=webhook-thoughtmarks-install-${Date.now()}`;
';'';
...
REQUIRED_SCOPES.split(',').forEach(_(scope) => {`;
  console.log(`   • ${scope}`)})';'';
console.log('')';'';
