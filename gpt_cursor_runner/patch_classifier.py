...
class PatchClassifier:
    ...
    def _define_roles(self) -> Dict[str, PatchRole]:
        ...
        return {
            ...
            "modal": PatchRole(
                name="modal",
                patterns=[r"<Modal", r"Modal\.", r"modal", r"Dialog", r"Overlay"],
                file_patterns=[
                    r".*modal.*\.tsx?$",
                    r".*Modal.*\.tsx?$",
                    r".*dialog.*\.tsx?$",
            ...
            "image": PatchRole(
                name="image",
                patterns=[r"<Image", r"Image\.", r"src=", r"source=", r"require\("],
                file_patterns=[
                    r".*image.*\.tsx?$",
                    r".*Image.*\.tsx?$",
                    r".*asset.*\.tsx?$",
            ...
            "icon": PatchRole(
                name="icon",
                patterns=[r"<Icon", r"Icon\.", r"icon", r"svg", r"FontAwesome"],
                file_patterns=[r".*icon.*\.tsx?$", r".*Icon.*\.tsx?$"],
                safety_level="safe",
                auto_approve=True,
                requires_review=False,
            ...
            "style": PatchRole(
                ...
                file_patterns=[r".*style.*\.tsx?$", r".*css.*\.tsx?$"],
                safety_level="safe",
                auto_approve=True,
                requires_review=False,
    ...
    def _calculate_confidence(
        self, target_file: str, pattern: str, replacement: str, role: str
    ) -> float:
    ...
    def _get_matched_patterns(
        self, target_file: str, pattern: str, role: str
    ) -> List[str]:
    ...
    def _is_safe_pattern(self, pattern: str) -> bool:
        ...
        if any(
            ...
            for word in ["text", "label", "title", "color", "style"]
        ):
            return True
    ...
    def get_all_roles(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            role_name: self.get_role_rules(role_name) for role_name in self.roles.keys()
        }
