...
def handle_slack_command(request_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            pass
        return {"response_type": "ephemeral", "text": f"❌ {error_msg}"}
            ...
            "blocks": [
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": (
                            f"✅ *Patch Approved Successfully*\n\n"
                            f"*ID:* `{latest_patch.get('id')}`\n"
                            f"*Target:* `{latest_patch.get('target_file')}`\n"
                            f"*Description:* {latest_patch.get('description')}"
                        ),
                    },
                },
                {
                    ...
                    "elements": [
                        {
                            "type": "mrkdwn",
                            "text": f"Approved by <@{user_id}> • {result.get('message',
            ...
            "blocks": [
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": (
                            f"♻️ *Patch Reverted Successfully*\n\n"
                            f"*ID:* `{latest_patch.get('id')}`\n"
                            f"*Target:* `{latest_patch.get('target_file')}`\n"
                            f"*Description:* {latest_patch.get('description')}"
                        ),
                ...
                },
                {
                    ...
                    "elements": [
                        {
                            "type": "mrkdwn",
                            "text": f"Reverted by <@{user_id}> • {result.get('message',
    ...
    try:
        ...
        return {"response_type": "in_channel",
                ...
                "blocks": [{"type": "section",
                           ...
                           {"type": "context",
                            "elements": [{"type": "mrkdwn",
                                          "text": f"Requested by\n<@{user_id}> • Use `/show-roadmap` to see a more detailed version",
                                          }],
                            },
                           ],
                }
    ...
    try:
        ...
        return {"response_type": "in_channel",
                ...
                "blocks": [{"type": "section",
                           ...
                           {"type": "context",
                            "elements": [{"type": "mrkdwn",
                                          "text": f"Requested\nby <@{user_id}> • Use `/roadmap` to see a high-level overview",
                                          }],
                            },
                           ],
                }
...
def handle_retry_last_failed_command(
    ...
    try:
        ...
        return {"response_type": "in_channel",
                ...
                "blocks": [{"type": "section",
                            "text": {"type": "mrkdwn",
                                    "text": "🔄 *Retrying Last Failed Patch...*nnThis command is not yet fully implemented."
                                     },
                            },
                           {"type": "context",
                            "elements": [{"type": "mrkdwn",
...
def handle_alert_runner_crash_command(
    ...
    try:
        ...
        return {"response_type": "in_channel",
                ...
                "blocks": [{"type": "section",
                            "text": {"type": "mrkdwn",
                                    "text": "⚠️ *Alerting Runner to Crash...*nnThis command is not yet fully implemented."
                                     },
                            },
                           {"type": "context",
                            "elements": [{"type": "mrkdwn",
...
def handle_troubleshoot_oversight_command(
    ...
    try:
        ...
        return {"response_type": "in_channel",
                ...
                "blocks": [{"type": "section",
                            "text": {"type": "mrkdwn",
                                    "text": "👀 *Troubleshooting Oversight...*nnThis command is not yet fully implemented."
                                     },
                            },
                           {"type": "context",
                            "elements": [{"type": "mrkdwn",
...
def handle_patch_command(text: str, user_id: str, channel_id: str) -> Dict[str, Any]:
    ...
    if not text.strip():
        return {
            "response_type": "ephemeral",
"text": "❌ Please provide patch details. Usage: `/patch <file> <desc> <pattern>
<replacement>`",
        }
    ...
    try:
        ...
        return {
            ...
            "blocks": [
                {
                    "type": "section",
                    "text": {"type": "mrkdwn", "text": "*📊 Patch Status Report*"},
                },
                {
                    "type": "section",
                    "fields": [
...
the system.",
                           ...
                           {"type": "section",
                            "fields": [{"type": "mrkdwn",
"text": "*Patch Commands:*\n• `/patch` - Create a patch\n• `/patch-preview` - Preview a
patch\n• `/patch-status` - Show patch stats\n• `/patch-approve` - Approve latest
patch\n• `/patch-revert` - Revert latest patch",
                                        },
                                       {"type": "mrkdwn",
"text": "*System Commands:*\n• `/dashboard` - Open dashboard\n• `/pause-runner` - Pause
...
restart the runner.",
                           ...
                           {"type": "context",
                            "elements": [{"type": "mrkdwn",
                                          "text": f"Requested by\n<@{user_id}> • This will retry the most recent failed operation",
                                          }],
                            },
                           ],
                }
...
Slack channels.",
                           ...
                           {"type": "context",
                            "elements": [{"type": "mrkdwn",
                                          "text": f"Enabled\nby <@{user_id}> • Cursor will now send updates to this channel",
                                          }],
                            },
                           ],
                }
...
channels.",
                           ...
                           {"type": "context",
                            "elements": [{"type": "mrkdwn",
                                          "text": f"Enabled\nby <@{user_id}> • GPT will now send updates to this channel",
                                          }],
                            },
                           ],
                }
