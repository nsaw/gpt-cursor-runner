...
def view_patch(patch_file: str, show_content: bool = False):
    ...
    try:
        ...
        if show_content:
            ...
            print(f"🔄 Replacement: {patch_data.get('patch', {}).get('replacement', 'N/A')}")
...
def main():
    ...
    parser.add_argument("--show-content", action="store_true", help="Show patch content")
    parser.add_argument("--limit", type=int, default=10, help="Limit number of patches shown")
